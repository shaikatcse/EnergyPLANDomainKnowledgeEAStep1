...
public class OPtimizeEnergyPLANCivisCEDIS4DTrasnportMain {
	...
	public static void main(String[] args) throws JMException,
		...
		for (int i = 0; i < numberOfRun; i++) {
			...
			writeStoppingGenerationInFile(i, stopGen,
					"C:\\Users\\mahbub\\Documents\\GitHub\\EnergyPLANDomainKnowledgeEAStep1\\CivisResults\\CEDIS\\4Objectives");
