...
package reet.fbk.eu.OptimizeEnergyPLANCIVIS.metaheuristics;
...
public class NSGAIIForDKTest extends NSGAII {
	...
	public NSGAIIForDKTest(Problem problem) {
		super(problem);
		//repairSolution = new RepairSolution();

	} // NSGAII

	public NSGAIIForDKTest(Problem problem, long seed, String folderName) {
		super(problem);
		repairSolution = new RepairSolution();
