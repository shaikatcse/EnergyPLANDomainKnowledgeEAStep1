...
public class EnergyPLANProblemStep1Main {
	...
	public static void main(String[] args) throws JMException,
		...
		problem = new EnergyPLANProblemStep1("BinaryIntAndReal",noOfBinaryIntVariable, noOfRealVariable);
		...
		// Mutation and Crossover for Binary codification
				...
				parameters = new HashMap();
				parameters.put("bitFlipMutationProbability", 1/(double)noOfRealVariable);
				parameters.put("polynomialMutationProbability", 1/(double)noOfRealVariable);
				parameters.put("distributionIndex", 20.0) ;
