...
import reet.fbk.eu.OprimizeEnergyPLAN.file.parse.*;
...
public class EnergyPLANProblemStep1 extends Problem {
	 ...
	 */
	public EnergyPLANProblemStep1(String solutionType, int noOfBinaryInt, int noOfReal) {
		numberOfVariables_ = noOfBinaryInt+noOfReal;
		...
		if (solutionType.compareTo("BinaryIntAndReal") == 0)
			solutionType_ = new BinaryIntAndRealSolutionType(this, noOfBinaryInt, noOfReal );
		else {
	...
	void writeModificationFile(Solution solution) {
		...
		// wind
		double RE1 = ((BinaryInt) solution.getDecisionVariables()[0]).getValue();
		// off-shore wind
		double RE2 = ((BinaryInt) solution.getDecisionVariables()[1]).getValue();
		// PV
		double RE3 = ((BinaryInt) solution.getDecisionVariables()[2]).getValue();
		// condencing PP
		double PP = ((BinaryInt) solution.getDecisionVariables()[3]).getValue();

		// PP coal share
		double PP_coal_share = ((Real) solution.getDecisionVariables()[4]).getValue();
		// pp oil sahre
		double PP_oil_share = ((Real) solution.getDecisionVariables()[5]).getValue();;
		// pp Ngas share
		double PP_ngas_share = ((Real) solution.getDecisionVariables()[6]).getValue();;
