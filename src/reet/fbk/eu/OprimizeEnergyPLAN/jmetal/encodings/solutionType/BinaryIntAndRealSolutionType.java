...
package reet.fbk.eu.OprimizeEnergyPLAN.jmetal.encodings.solutionType;
 ...
 * and a real.
 */
public class BinaryIntAndRealSolutionType extends SolutionType {
	 ...
	 */
	public BinaryIntAndRealSolutionType(Problem problem, int intVariables, int realVariables) {
		super(problem) ;
	...
	public Variable[] createVariables() throws ClassNotFoundException {
		...
		for (int var = 0; var < intVariables_; var++){
			...
			int requireNoOfBits =  ((int) Math.floor( Math.log(problem_.getUpperLimit(var))/Math.log(2)) +1);

			variables[var] = new BinaryInt(requireNoOfBits,(int)problem_.getLowerLimit(var), (int)problem_.getUpperLimit(var)); 
	...
	public int getintVariables(){
		return intVariables_;
	}
	
	public int getRealVariables(){
