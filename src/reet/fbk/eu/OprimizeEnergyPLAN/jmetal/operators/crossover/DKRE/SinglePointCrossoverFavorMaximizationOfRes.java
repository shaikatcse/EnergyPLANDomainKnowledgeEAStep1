package reet.fbk.eu.OprimizeEnergyPLAN.jmetal.operators.crossover.DKRE;
 ...
 * solutions.
 */
public class SinglePointCrossoverFavorMaximizationOfRes extends Crossover {
	/**
	 ...
	 */
	public SinglePointCrossoverFavorMaximizationOfRes(
