...
import reet.fbk.eu.OprimizeEnergyPLAN.jmetal.operators.crossover.SBXIntegerCrossover;
...
public class SBXCrossoverMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			SBXIntegerCrossover sb = new SBXIntegerCrossover(hm);
			...
			for (int i = 0; i < 100; i++) {
				...
				p1[0].setUpperBound(1000);
				p1[0].setLowerBound(0);
				p1[0].setValue(b);
				...
				p2[0].setUpperBound(1000);
				p2[0].setLowerBound(0);
				p2[0].setValue(b);
