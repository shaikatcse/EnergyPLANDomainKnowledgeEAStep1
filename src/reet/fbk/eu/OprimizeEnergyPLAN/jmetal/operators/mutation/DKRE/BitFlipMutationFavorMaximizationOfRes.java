package reet.fbk.eu.OprimizeEnergyPLAN.jmetal.operators.mutation.DKRE;
 ...
 */
public class BitFlipMutationFavorMaximizationOfRes extends Mutation {
	/**
	 ...
	 */
	public BitFlipMutationFavorMaximizationOfRes(
					...
					if (solution.getDecisionVariables()[i].getClass() == BinaryInt.class) {
						...
						if (PseudoRandom.randDouble() < probability) {
							...
							if (favorGenes[i] == true) {
								...
								// and this attempt will do for 50 times,
								// because if
								// all bits are '1', then it will put into
								// infinite
								// loop

								do {
									++attempt;
									random_number = PseudoRandom
											.randInt(1, ((int) Math.pow(2,
													numberOfBits) - 1));
