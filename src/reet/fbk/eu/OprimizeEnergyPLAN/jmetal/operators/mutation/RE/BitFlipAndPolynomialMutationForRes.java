...
package reet.fbk.eu.OprimizeEnergyPLAN.jmetal.operators.mutation.RE;
 ...
 */
public class BitFlipAndPolynomialMutationForRes extends Mutation {
  /**
  ...
  /**
	 ...
	 */
	public BitFlipAndPolynomialMutationForRes(HashMap<String, Object> parameters) {
		super(parameters) ;
