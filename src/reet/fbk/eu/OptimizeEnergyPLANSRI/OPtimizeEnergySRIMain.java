package reet.fbk.eu.OptimizeEnergyPLANSRI;
...
import reet.fbk.eu.OptimizeEnergyPLANSRI.Problem.EnergyPLANProblemSRI;
import reet.fbk.eu.OptimizeEnergyPLANSRI.Problem.EnergyPLANProblemSRIV3;
import reet.fbk.eu.OptimizeEnergyPLANSRI.Problem.EnergyPLANProblemSRIV4Spooling;
import reet.fbk.eu.OptimizeEnergyPLANSRI.metaheuristics.nsgaii.NSGAIISpooling;
import reet.fbk.eu.OptimizeEnergyPLANSRI.util.WriteDataToFile;
//import reet.fbk.eu.jmetal.operators.mutation.MutationFactory;
...
import reet.fbk.eu.OptimizedEnergyPLANFelicetti.Problem.EnergyPLANProblemFelicettiV2;
...
public class OPtimizeEnergySRIMain {
	...
	public static void main(String[] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
		...
		for (int year = 0; year < simulatedYear.length; year++) {
			...
			for (int i = 0; i < numberOfRun; i++) {
				...
				problem = new EnergyPLANProblemSRIV4Spooling("Real", simulatedYear[year], folder);
			...
			/*	ExtractEnergyPLANParametersTrentoProvinceV10 ex = new ExtractEnergyPLANParametersTrentoProvinceV10(
				...
				//write all solutions
				HashMap hm = ((EnergyPLANProblemSRIV4Spooling)problem).getTheList();
