 ...
 *
 */
public class NSGAIIForDKandSC extends NSGAII {
	...
	public NSGAIIForDKandSC(Problem problem) {
		super(problem);
		stopMOEA = new StopMOEA();
		//repairSolution = new RepairSolution();

	} // NSGAII

	public NSGAIIForDKandSC(Problem problem, long seed, String folderName) {
		super(problem);
		stopMOEA = new StopMOEA();
		//repairSolution = new RepairSolution();
