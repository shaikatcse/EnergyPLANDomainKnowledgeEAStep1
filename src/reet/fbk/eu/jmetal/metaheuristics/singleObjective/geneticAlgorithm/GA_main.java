package reet.fbk.eu.OprimizeEnergyPLAN.jmetal.metaheuristics.singleObjective.geneticAlgorithm;
...
import reet.fbk.eu.OprimizeEnergyPLAN.jmetal.metaheuristics.singleObjective.geneticAlgorithm.gGA;
import reet.fbk.eu.OprimizeEnergyPLAN.jmetal.problems.singleObjective.Add5Numbers;
...
public class GA_main {
	...
	public static void main(String[] args) throws JMException,
		...
		/*
		 * // Mutation and Crossover for Real codification parameters = new
		 * HashMap() ; parameters.put("probability", 0.9) ;
		 * parameters.put("distributionIndex", 20.0) ; crossover =
		 ...
		 * parameters.put("distributionIndex", 20.0) ; mutation =
		...
		parameters.put("SBXCrossoverProbability", 0.8);
		parameters.put("distributionIndex", 20.0) ;
		crossover = CrossoverFactory.getCrossoverOperator(
				"SinglePointAndSBXCrossoverForRes", parameters);

		parameters = new HashMap();
		parameters.put("bitFlipMutationProbability", 0.1);
		parameters.put("polynomialMutationProbability", 0.2);
		parameters.put("distributionIndex", 20.0) ;
