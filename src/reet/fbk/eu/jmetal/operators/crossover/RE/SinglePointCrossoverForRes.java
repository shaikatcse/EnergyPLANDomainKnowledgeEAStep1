...
public class SinglePointCrossoverForRes extends Crossover {
	/**
	 ...
	 */
	public SinglePointCrossoverForRes(HashMap<String, Object> parameters) {
		super(parameters);
		...
		try {
			if (PseudoRandom.randDouble() < probability) {
...

				{
					...
					for (int i = 0; i < parent1.getDecisionVariables().length
							- numberOfRealVariable; i++) {
