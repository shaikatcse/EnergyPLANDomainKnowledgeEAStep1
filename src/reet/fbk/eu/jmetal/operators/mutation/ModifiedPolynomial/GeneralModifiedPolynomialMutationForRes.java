 ...
 */
public class GeneralModifiedPolynomialMutationForRes extends Mutation {
	/**
	...
	public static void main(String args[]) throws JMException{
		...
		GeneralModifiedPolynomialMutationForRes gmu = new GeneralModifiedPolynomialMutationForRes(hm);
