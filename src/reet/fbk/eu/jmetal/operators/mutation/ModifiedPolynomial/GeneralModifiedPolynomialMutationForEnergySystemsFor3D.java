 ...
 */
public class GeneralModifiedPolynomialMutationForEnergySystemsFor3D extends Mutation {
	/**
	 ...
	 * 
	 */
	public GeneralModifiedPolynomialMutationForEnergySystemsFor3D(
	...
	public static void main(String args[]) throws JMException, ClassNotFoundException {
		...
		GeneralModifiedPolynomialMutationForEnergySystemsFor3D gmu = new GeneralModifiedPolynomialMutationForEnergySystemsFor3D(
				hm);
