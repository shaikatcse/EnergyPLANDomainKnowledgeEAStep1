...
public class ModifiedPolynomialMutationFavorLoaDFollowingCapacity extends PolynomialMutation {
	 ...
	 */
	public ModifiedPolynomialMutationFavorLoaDFollowingCapacity(HashMap<String, Object> parameters, Boolean favorGenes[]) {
		super(parameters);
