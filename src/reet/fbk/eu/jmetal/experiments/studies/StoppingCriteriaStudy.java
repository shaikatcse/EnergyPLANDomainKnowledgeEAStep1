...
package reet.fbk.eu.jmetal.experiments.studies;
 ...
 * in NSGA-II.
 */
public class StoppingCriteriaStudy extends Experiment {
  /**
  ...
  public synchronized void algorithmSettings(String problemName, 
    ...
    throws ClassNotFoundException {  	
      ...
      parameters[0].put("baseDirectory", "C:/Users/mahbub/Documents/GitHub/EnergyPLANDomainKnowledgeEAStep1");
  ...
  public static void main(String[] args) throws JMException, IOException {
	  StoppingCriteriaStudy exp = new StoppingCriteriaStudy() ; // exp = experiment
