package reet.fbk.eu.OptimizedEnergyPLANFelicetti;
...
import reet.fbk.eu.OptimizedEnergyPLANFelicetti.util.WriteDataToFile;
...
public class OPtimizeEnergyFelicettiMain {
	...
	public static void main(String[] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
		...
		String[] simulatedYear = { "2018" };

		for (int year = 0; year < simulatedYear.length; year++) {
			int numberOfRun = 1;

			String folder = "C:\\Diego Viesi\\Lavoro\\FBK\\progetti e proposals\\PROGETTI\\progetto INSHIP\\WP5\\proposta per tesi di laurea\\Felicetti\\MOEA results\\Shahriar\\v2" + "\\" + simulatedYear[year];
			...
			for (int i = 0; i < numberOfRun; i++) {
				...
				problem = new EnergyPLANProblemFelicettiV2("Real", simulatedYear[year], folder);
			...
			/*	ExtractEnergyPLANParametersTrentoProvinceV10 ex = new ExtractEnergyPLANParametersTrentoProvinceV10(
				...
				//write all solutions
				HashMap hm = ((EnergyPLANProblemFelicettiV2)problem).getTheList();
