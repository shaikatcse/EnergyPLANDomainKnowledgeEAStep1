 ...
 */
public class EnergyPLANProblemVdN2DWithH2VehicleModifiedCO2 extends Problem {
	...
	*/
	...
	public EnergyPLANProblemVdN2DWithH2VehicleModifiedCO2(String solutionType, String simulatedYear, String simulatedScenario) {
	...
	public void evaluate(Solution solution) throws JMException {
		...
		// index - 4 -> Biomass micro chp heat percentage
		// last percentage will go to individual HP percentage
		// index - 5 -> FCEV(H2) car percentage
		...
		// cars' percentages
		double FCEVCarPercentage = solution.getDecisionVariables()[5].getValue();
		double conCarPercentage = 1- FCEVCarPercentage;
		
		double totalKMRunByConCar = (int) totalKMRunByCars * conCarPercentage;
		//double totalKMRunByEVCar = (int) totalKMRunByCars * FCEVCarPercentage;
	...
	void writeIntoInputFile(double pv, double oilBoilerHeatPercentage,
		...
		double numberOfEVCars = totalH2DemandInGWhForTrns * Math.pow(10, 6)
