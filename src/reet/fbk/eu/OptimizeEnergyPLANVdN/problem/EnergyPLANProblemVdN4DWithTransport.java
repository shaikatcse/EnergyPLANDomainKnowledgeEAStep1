 ...
 */
public class EnergyPLANProblemVdN4DWithTransport extends Problem {
	...
	public static final double efficiencyBiomassCHP = 0.5;

	// H2
	public static final double efficiencyElectrolyzerTrans = 0.74;
	public static final double maxH2DemandInDistribution = 1.0;
	public static final double sumH2DemandInDistribution = 2928.0; // check
	 ...
	 */
	public EnergyPLANProblemVdN4DWithTransport(String solutionType) {
	...
	void writeModificationFile(double pv, double oilBoilerHeatPercentage,
		...
		try {
			...
			bw.write(str);
			bw.newLine();
			str = "" + biomassBoilerFuelDemand * efficiencyBiomassCHP
	...
	void writeIntoInputFile(double pv, double oilBoilerHeatPercentage,
		...
		String path ="C:\\Users\\mahbub\\Documents\\GitHub\\EnergyPLANDomainKnowledgeEAStep1\\EnergyPLAN_12.3\\energyPlan Data\\Data\\VdN_2020.txt";
		...
		double biomassCHPSolarThermal = biomassBoilerFuelDemand
				* efficiencyBiomassCHP * biomassCHPSolarPercentage;
