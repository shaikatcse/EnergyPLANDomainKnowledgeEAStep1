...
public class OPtimizeEnergyPLANVdNTrasnportMOdifiedCO2Main {
	...
	public static void main(String[] args) throws JMException,
		...
		String[] simulatedScenario = { "2DS", "4DS" };

		for (int year = 0; year < simulatedYear.length; year++) {
			for (int scenario = 0; scenario < simulatedScenario.length; scenario++) {
				int numberOfRun = 2;

				String folder = "C:\\Users\\mahbub\\Documents\\GitHub\\EnergyPLANDomainKnowledgeEAStep1\\VdNResults\\ShahriarEleboration\\ElecTransport\\"
				...
				for (int i = 0; i < numberOfRun; i++) {
					...
					problem = new EnergyPLANProblemVdN2DWithElecVehicleModifiedCO2(
					...
					if (simulatedYear[year].equals("2020")
							|| simulatedYear[year].equals("2030")) {
																	// pv     oB    ngb   bB   bCHP   EV    oS    nGS        bbS    bCHPs   HPS
					  ...
					  else {                                       // pv      oB   ngb    bB    bCHP   EV     oS      nGS     bbS    bCHPs HPS
						favorGenesforRE =             new Boolean[] {true,  false, null, true, true,  true,  true,   true,  true,   true,   true };
				...
				ExtractEnergyPLANParametersVdN2DWithElecTransport ob = new ExtractEnergyPLANParametersVdN2DWithElecTransport(simulatedYear[year],
						simulatedScenario[scenario]);
