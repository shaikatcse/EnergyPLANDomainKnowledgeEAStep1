...
plot "Bottom15AnnualCost" using 30:24:30:xtic(31) with boxes palette notitle
...
set ylabel "LFC"
set yrange [0.46:0.51]
set ytics 0.01
plot "Bottom15AnnualCost" using 30:28:30:xtic(31) with boxes palette notitle
